...
${OBJECTDIR}/src/DRE.o: src/DRE.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DRE.o src/DRE.cpp

${OBJECTDIR}/src/fm1FSM.o: src/fm1FSM.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fm1FSM.o src/fm1FSM.cpp

${OBJECTDIR}/src/fm1FSM_CI.o: src/fm1FSM_CI.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fm1FSM_CI.o src/fm1FSM_CI.cpp

${OBJECTDIR}/src/prj_dre.o: src/prj_dre.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/prj_dre.o src/prj_dre.cpp
...
${OBJECTDIR}/src/prj_lcd.o: src/prj_lcd.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/prj_lcd.o src/prj_lcd.cpp
...
${OBJECTDIR}/src/prj_tty_brcast.o: src/prj_tty_brcast.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/prj_tty_brcast.o src/prj_tty_brcast.cpp

${OBJECTDIR}/src/prj_tty_cmds.o: src/prj_tty_cmds.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/prj_tty_cmds.o src/prj_tty_cmds.cpp

${OBJECTDIR}/src/pwmFSM.o: src/pwmFSM.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pwmFSM.o src/pwmFSM.cpp

${OBJECTDIR}/src/pwmFSM_CI.o: src/pwmFSM_CI.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../dummylib -I../libraries/gatArduinOSEK -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pwmFSM_CI.o src/pwmFSM_CI.cpp
